################################################################################
# Name:    Paul Habjanetz
# Class:   CS2318-002 (Assembly Language, Fall 2013)
...
####################(4)####################      
					...
					addi $a0, $sp, 77	#load vals to do into stack pointer
					li $a1, 1		#load $a1 with 1
					li $a2, 7		#load $a2 with 7
					addi $a3, $sp, 28	#load adjMsg in $a3				
...
####################(8)####################
					...
					addi $a0, $sp, 13	#put stack pointer at 13 in $a0			
					jal GetOneIntByVal	#jump to GetOneIntByVal	
					
					lw $a1, 77($sp)		#load the value of ValsToDo into $a1
					sub $a1, $a1, $t1	#subtract i from $a1
					sll $a1, $a1, 2		#make it array
					
					addi $a2, $sp, 81	#load $a2 with intArr
					add $a1, $a2, $a1	#add $a1 and $a2
					sw $v0, 0($a1)
...
####################(7)#################### 
					...
					sll $a0, $a0, 2
					addi $a0, $a0, 81
					add $a0, $a0, $sp	#add stack pointer to intArr + valsToDo -i
					addi $a1, $sp, 13	#put entIntPrompt in sp at $a1
					jal GetOneIntByAddr
...
####################(3)####################
					...
					addi $a0, $sp, 81	#load $a0 with intArr
					lw $a1, 77($sp)		#load $a1 with valsToDo
					addi $a2, $sp, 46	#load $a2 with initLab				
					jal ShowIntArray
...
####################(3)####################
					...
					li $t1, 0		#load i with 0
					lw $a0, 77($sp)		#load $a0 with valsToDo
					addi $t2, $a0, -1	#add -1 to valsToDo and assign to j
...
####################(8)####################
					...
					move $a0, $t1		#move i into $a0
					sll $a0, $a0, 2		#prepare to combine with array
					addi $a0, $a0, 81	#add array and i
					add $a0, $a0, $sp	#assign sp to $a0
					
					move $a1, $t2		#move j into $a0
					sll $a1, $a1, 2		#prepare to combine with array
					addi $a1, $a1, 81	#add array and j
					add $a1, $a1, $sp	#assign sp to $a1								
...
####################(3)####################
					...
					addi $a0, $sp, 81	#load intArr into $a0
					lw $a1, 77($sp)		#load valsToDo into $a1
					addi $a2, $sp, 56	#load flipLab into $a2
...
####################(2)####################
					...
					addi $a0, $sp, 76	#load reply into $a0
					addi $a1, $sp, 66	#load dmprompt into $a1
					jal GetOneCharByAddr
#   }
#   while (reply != 'n' && reply != 'N');

####################(1)####################
					move $v1, $a0 		#move character into $v1
					li $t0, 'n'
